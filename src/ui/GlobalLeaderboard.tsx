            ...
            <div className="flex-1 max-w-4xl w-full mx-auto p-4 flex flex-col lg:flex-row gap-6">
                ...
                <div className="lg:w-80 shrink-0 space-y-4">
                        ...
                        {authenticated && user ? (
                            <div className="space-y-4 pt-2">
                                <div className="p-3 bg-emerald-500/5 border border-emerald-500/20 rounded-sm">
                                    ...
                                    <div className="text-[11px] text-[#8b95a5] font-mono break-all">{user.id}</div>
                                </div>

                                <div className="space-y-2">
                                    <div className="text-[9px] uppercase tracking-widest text-[#4a5565]">Linked Authentication</div>
                                    <div className="flex flex-wrap gap-2">
                                        {user.linkedAccounts.map((acc, i) => (
                                            <div key={i} className="px-2 py-1 bg-[#0d0f13] border border-[#1a1f28] text-[9px] text-[#8b95a5] uppercase rounded-sm">
                                                {acc.type}
                                            </div>
                                        ))}
                                    </div>
                                ...
                                <div className="text-[10px] text-[#5a6475] leading-relaxed italic">
                            ...
                            <div className="py-8 text-center border border-dashed border-[#1a1f28] rounded-sm">
                                <div className="text-[10px] text-[#4a5565] uppercase tracking-widest">Awaiting Verification</div>
                    ...
                    <div className="p-4 bg-[#0891b2]/5 border border-[#0891b2]/20 rounded-sm">
                        ...
                        <p className="text-[9px] text-[#5a6475] leading-normal uppercase tracking-wide">
                    ...
                    <div className="terminal-frame flex-1 flex flex-col overflow-hidden">
                        <div className="p-4 border-b border-[#1a1f28] flex items-center justify-between shrink-0">
                            <div>
                                ...
                                <p className="text-[10px] text-[#4a5565] mt-1">Movement Network • Immutability Layer Active</p>
                            </div>
                            <div className="text-right">
                                <span className="text-xl font-mono text-[#16a34a] font-bold">{entries.length}</span>
                                <div className="text-[8px] text-[#4a5565] uppercase tracking-tighter">Verified Runs</div>
                            </div>
                        </div>

                        <div className="flex-1 overflow-y-auto p-2 scrollbar-hide">
                            {loading ? (
                                <div className="text-center py-20 text-[#4a5565] text-[10px] uppercase tracking-widest animate-pulse">Scanning Registry...</div>
                            ) : (
                                    ...
                                    {entries.map((entry, i) => (
                                        ...
                                        >
                                            <div className="w-8 shrink-0 text-center">
                                                <span className={`text-[10px] font-bold ${i < 3 ? 'text-amber-500' : 'text-[#4a5565]'}`}>
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2">
                                                    <span className="text-[12px] font-semibold text-[#8b95a5] uppercase tracking-wide truncate">
                                                ...
                                                <div className="text-[9px] text-[#4a5565] flex items-center gap-2">
